...
public class AutoCompletion<T> extends PlainDocument {
    ...
    public AutoCompletion(final JComboBox<T> comboBox) {
        ...
        comboBox.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent e) {
                ...
                if (e.getPropertyName().equals("model")) model = (ComboBoxModel<T>) e.getNewValue();
            }
        });
    ...
    private void setSelectedItem(Object item) {
        ...
        scrollBar.setValue((int)(scrollBar.getMaximum()*comboBox.getSelectedIndex()/comboBox.getItemCount()));
        selecting = false;
    }
